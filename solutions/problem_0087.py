...
# below fifty that can be expressed in such a way: $$\begin{align} 28 &amp;=
# 2^2 + 2^3 + 2^4\\ 33 &amp;= 3^2 + 2^3 + 2^4\\ 49 &amp;= 5^2 + 2^3 + 2^4\\ 47
# &amp;= 2^2 + 3^3 + 2^4 \end{align}$$ How many numbers below fifty million
