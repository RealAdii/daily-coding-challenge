...
# lexicographically after its neighbour to the left. We now consider strings
# of $n \le 26$ different characters from the alphabet. For every $n$, $p(n)$
# is the number of strings of length $n$ for which exactly one character comes
# lexicographically after its neighbour to the left. What is the maximum value
# of $p(n)$?
