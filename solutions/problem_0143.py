...
# degrees. Let $X$ be any point inside the triangle and let $XA = p$, $XC =
# q$, and $XB = r$. Fermat challenged Torricelli to find the position of $X$
# such that $p + q + r$ was minimised. Torricelli was able to prove that if
...
# CO = p + q + r$ and that $AN$, $BM$ and $CO$ also intersect at $T$. If the
# sum is minimised and $a, b, c, p, q$ and $r$ are all positive integers we
...
# 784$. Find the sum of all distinct values of $p + q + r \le 120000$ for
