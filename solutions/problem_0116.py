...
# cannot be mixed there are $7 + 3 + 2 = 12$ ways of replacing the grey tiles
# in a row measuring five units in length. How many different ways can the
# grey tiles in a row measuring fifty units in length be replaced if colours
# cannot be mixed and at least one coloured tile must be used? NOTE: This is
# related to Problem 117 .
