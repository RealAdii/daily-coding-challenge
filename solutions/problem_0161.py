...
# account there are six: Any $n$ by $m$ grid for which $n \times m$ is
# divisible by $3$ can be tiled with triominoes. If we consider tilings that
# can be obtained by reflection or rotation from another tiling as different
