...
# all numbers produce palindromes so quickly. For example, $$\begin{align} 349
# + 943 &amp;= 1292\\ 1292 + 2921 &amp;= 4213\\ 4213 + 3124 &amp;= 7337
# \end{align}$$ That is, $349$ took three iterations to arrive at a
# palindrome. Although no one has proved it yet, it is thought that some
...
# there are palindromic numbers that are themselves Lychrel numbers; the first
