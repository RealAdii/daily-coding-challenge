...
# \frac12n(n+1)$; so the first ten triangle numbers are: $$1, 3, 6, 10, 15,
# 21, 28, 36, 45, 55, \dots$$ By converting each letter in a word to a number
...
# t_{10}$. If the word value is a triangle number then we shall call the word
# a triangle word. Using words.txt (right click and 'Save Link/Target As...'),
