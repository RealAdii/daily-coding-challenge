...
# 4+4+2 = 4+2+2+1+1 = 4+4+1+1.$ It can be shown that for every fraction $p /
# q$ ($p \gt 0$, $q \gt 0$) there exists at least one integer $n$ such that
...
# significant bit there are $4$ one's, $3$ zeroes and $1$ one. We shall call
# the string $4,3,1$ the Shortened Binary Expansion of $241$. Find the
