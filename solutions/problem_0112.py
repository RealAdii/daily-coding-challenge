...
# half of the numbers below one-thousand ($525$) are bouncy. In fact, the
# least number for which the proportion of bouncy numbers first reaches $50\%$
# is $538$. Surprisingly, bouncy numbers become more and more common and by
# the time we reach $21780$ the proportion of bouncy numbers is equal to
# $90\%$. Find the least number for which the proportion of bouncy numbers is
# exactly $99\%$.
