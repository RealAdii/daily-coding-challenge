...
# 5 + \cdots \\ &amp;= \tfrac{1}{2} + \tfrac{1}{4} + \tfrac{2}{8} +
# \tfrac{3}{16} + \tfrac{5}{32} + \cdots \\ &amp;= 2 \end{align*}$ The
# corresponding values of $x$ for the first five natural numbers are shown
# below. $x$ $A_F(x)$ $\sqrt{2}-1$ $1$ $\tfrac{1}{2}$ $2$
# $\frac{\sqrt{13}-2}{3}$ $3$ $\frac{\sqrt{89}-5}{8}$ $4$
# $\frac{\sqrt{34}-3}{5}$ $5$ We shall call $A_F(x)$ a golden nugget if $x$ is
# rational, because they become increasingly rarer; for example, the $10$th
# golden nugget is $74049690$. Find the $15$th golden nugget.
