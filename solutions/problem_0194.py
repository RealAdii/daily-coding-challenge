...
# $(a, b, c)$ is a graph thus built of $a$ units $A$ and $b$ units $B$, where
# the graph's vertices are coloured using up to $c$ colours, so that no two
...
# all $c \ge 4$. Let $N(a, b, c)$ be the number of configurations of type $(a,
# b, c)$. For example, $N(1,0,3) = 24$, $N(0,2,4) = 92928$ and $N(2,2,3) =
