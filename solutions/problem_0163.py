...
# vertex to the middle of the opposite side, such as in the size $1$ triangle
# in the sketch below. Sixteen triangles of either different shape or size or
...
# triangle contains $4$ size $1$ triangle building blocks. A size $3$ triangle
# would contain $9$ size $1$ triangle building blocks and a size $n$ triangle
# would thus contain $n^2$ size $1$ triangle building blocks. If we denote
# $T(n)$ as the number of triangles present in a triangle of size $n$ , then
