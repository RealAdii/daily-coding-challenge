...
# 1} + F_{n - 2}$, where $F_1 = 1$ and $F_2 = 1$. It turns out that $F_{541}$,
...
# but not necessarily in order). And $F_{2749}$, which contains $575$ digits,
# is the first Fibonacci number for which the first nine digits are $1$-$9$
# pandigital. Given that $F_k$ is the first Fibonacci number for which the
