...
# corner angles are $45^\circ$. Another example is given by $DAC = 20^\circ$,
# $BAC = 60^\circ$, $ABD = 50^\circ$, $CBD = 30^\circ$, $BCA = 40^\circ$, $DCA
# = 30^\circ$, $CDB = 80^\circ$, $ADB = 50^\circ$. What is the total number of
# non-similar integer angled quadrilaterals? Note: In your calculations you
# may assume that a calculated angle is integral if it is within a tolerance
# of $10^{-9}$ of an integer value.
